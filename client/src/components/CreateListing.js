...
import ConditionChecklist from './ConditionChecklist'; // Adjust path if needed
...
const CreateListing = ({ userId }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // 3. APPEND CHECKLIST TO FORMDATA
      ...
      if (res.status === 201 || res.status === 200) {
        ...
        setImageFile(null);
        setConditionChecklist([]); // Reset checklist
      }
    } catch (err) {
  ...
  return (
    <div className="container mt-5">
      ...
      <form onSubmit={handleSubmit} className="p-4 shadow-sm bg-white rounded">
        ...
        {/* 5. ADD THE CHECKLIST COMPONENT HERE */}
        <div className="mb-3">
          <ConditionChecklist 
